...
class SalesReport extends React.Component {
  ...
  fetchsalesData = () => {
    Axios.get(
      `${API_URL}/admin/sales?warehouse_id=${this.state.adminData.warehouse_id}`
    )
      .then((result) => {
  ...
  fetchTopThree = () => {
    Axios.get(
      `${API_URL}/admin/top-three?warehouse_id=${this.state.selectedWarehouse}`
    )
      .then((result) => {
    ...
    return this.state.topThree.map((val, key) => {
      return (
        <tr>
          ...
          <td>
            <img
              src={API_URL + "/public" + val.product_image}
  ...
  fetchTimeList = () => {
    ...
    Axios.get(
      `${API_URL}/admin/time-transaction?warehouse_id=${this.state.selectedWarehouse}`
    )
      .then((result) => {
      ...
      <div className="sales-page">
        ...
        {this.props.userGlobal.auth_status === "superadmin" ? (
          <>
            <h3>
              You are a{" "}
              <u>
                <b>{this.props.userGlobal.auth_status}</b>
              </u>
              . You can see sales report from all warehouses.
            </h3>
          ...
          <h3>
            You are an {this.props.userGlobal.auth_status} of warehouse:{" "}
            <u>
              <b>{this.state.adminData.warehouse_name}</b>
            </u>
            . You can see sales report for this warehouse.
          </h3>
        )}
        ...
        <div className="d-flex flex-row justify-content-around mx-2 mt-3">
          <div className="col-3">
            ...
            <table className="table">
              ...
              <tbody>{this.renderTopThree()}</tbody>
            </table>
          </div>
          <div className="col-6">
        ...
        <div className="col-12 mt-5">
          ...
          <table className="table">
            ...
            <tbody>{this.renderSalesReport()}</tbody>
          </table>
        </div>
      </div>
    );
